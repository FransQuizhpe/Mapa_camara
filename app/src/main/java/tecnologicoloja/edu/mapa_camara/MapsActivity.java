...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener, View.OnClickListener {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        btn1 = (Button) findViewById(R.id.btnlocali);
        //Botón de Guardar Lugares con el SharedPreferences
        btn2 = (Button) findViewById(R.id.btncar);
        btn3 = (Button) findViewById(R.id.btncamara);
    ...
    public void onMapLongClick(LatLng latLng) {
        ...
        Marker ubicacion = mMap.addMarker(new MarkerOptions().position(latLng).title("Ubicación Actual").icon(BitmapDescriptorFactory.fromResource(R.drawable.carrito)));
